...
function AutoLayui() {
  var $content = '<div style="padding: 15px; background-color: #fff;">'
               ...
               + '      <br />'
               + '      <br />'
               + '      e参数为模块,<span class="ys-red">注：此模块仅支持2.6.0以下版本</span>, 如e="layui" 或 e="layui.all" 即自动引入 layui 或 layui.all 的js模块文件, 如不携带e参数则默认为layui 例: &lt;script src="https://www.layuicdn.com/auto/layui.js" e="layui.all"&gt;&lt;/script&gt;'
               + '    </blockquote>'
               + '    <blockquote class="layui-elem-quote" style="border: none !important;font-size: 13px !important; margin-bottom: 0px !important;">'
...
var $layuicdn_options = {
  strings: ['2024&#x795D;&#x5927;&#x5BB6;...&#x641E;&#x9519;&#x4E86;...&#x518D;&#x6765;','&#x795D;&#x5E7F;&#x5927;&#x7528;&#x6237;&#x5728;2025&#x65B0;&#x65F6;&#x4EE3; Happy New Year&#xFF01;']
