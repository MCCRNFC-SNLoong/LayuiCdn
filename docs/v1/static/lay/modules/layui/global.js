...
layui.define(['code', 'element', 'table', 'util', 'carousel', 'laytpl'], function(exports){
  ...
  ;!function(){
    ...
    form.on('select(component)', function(data){
      ...
      location.href = /^\//.test(value) ? value : ('/docs/v1/doc/'+ value);
    });
  }();
  ...
  ;!function(){
    ...
    })([{"classname":"toptg","key":"toptg-notice","title":"layui 官网下线公告","url":"/docs/v1/about/notice.html","CONFIG_TIME":"9/26/2021, 6:25:48 PM","tips":"","tipsCss":"background-image: linear-gradient(to right,#359FD4,#36B5C8,#25D8AB","hot":"1"}]);
  }();
  ...
  var events = {
    ...
    contactInfo: function(){
      layer.alert('<div class="layui-text">如有合作意向，可联系：<br>QQ：1609928143</div>', {
        title:'联系'
        ,btn: false
        ,shadeClose: true
      });
    ...
    $('.site-down').on('click',function(e){
      ...
      if(!local.disclaimer){
        ...
        layer.confirm([
          ...
          ,'请先阅读《<a href="/docs/v1/about/disclaimer.html" target="_blank">layui 开源界面框架免责声明</a>》'
          ,'，再进行下载</div>'
        ].join(''), {
          title: '下载提示'
          ,btn: ['已阅读', '取消']
    ...
    if(elemHome.data('date') === '4-1'){
      ...
      setTimeout(function(){
        layer.photos({
          photos: {
            "data": [{
              "src": "/docs/v1/upload/2018_4/168_1522515820513_397.png",
            }]
          }
          ,anim: 2
          ,shade: 1
